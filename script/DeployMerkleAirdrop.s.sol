...
contract DeployMerkleAirdrop is Script {
    ...
    function deployMerkleAirdrop() public returns (MerkleAirdrop, ChickenToken) {
        vm.startBroadcast();
        ChickenToken bagelToken = new ChickenToken();
    ...
    function run() external returns (MerkleAirdrop, ChickenToken) {
